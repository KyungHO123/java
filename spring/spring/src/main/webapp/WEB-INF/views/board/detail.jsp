...
<body>
	...
	<div class="input-group mb-3 mt-3">
		<button class="btn btn-outline-success btn-up co-6">추천(${board.bo_up})</button>
		<button class="btn btn-outline-success btn-down co-6">비추천(${board.bo_down})</button>
	</div>
	<div>
		<label>내용</label>
