		...
		<c:forEach items="${list}" var="board">
			<tr>
				...
				<c:url value="/board/list" var="url">
						...
						<c:param name="serach" value="${board.bo_me_id}"></c:param>
				</c:url>
...
<ul class="pagination justify-content-center">
	<c:if test="${pm.prev}">
		<c:url value="/board/list" var="url">
			<c:param name="page" value="${pm.cri.startPage - 1}"></c:param>
			<c:param name="type" value="${pm.cri.type}"></c:param>
			<c:param name="serach" value="${pm.cri.search}"></c:param>
		</c:url>
	...
	<c:forEach begin="${pm.startPage}" end="${pm.endPage}" var="i">
		<c:url value="/board/list" var="url">
			...
			<c:param name="page" value="${pm.cri.type}"></c:param>
			<c:param name="page" value="${pm.cri.search}"></c:param>
		</c:url>
	...
	<c:if test="${pm.next}">
		<c:url value="/board/list" var="url">
			<c:param name="page" value="${pm.cri.endPage + 1}"></c:param>
			<c:param name="page" value="${pm.cri.type}"></c:param>
			<c:param name="page" value="${pm.cri.search}"></c:param>
		</c:url>
