...
public class LogicalOperatorEx1 {
	...
	public static void main(String[] args) {
		...
		//성적이 0보다 (크거나 같)(고), 성적이 100보다 (작거나 같)(다)
		//성적 >= 0 && 성적 <=  100
		System.out.println(score + "점은 올바른 성적인가?" + (0 <= score && score <= 100));
		
		//앞 결과의 반대가 출력
		System.out.println(score + "점은 올바른 성적이 아닌가?" + !(0 <= score && score <= 100));
		/* 성적이 올바르지 않은지를 확인 올바르지 않은 성적인 0미만, 100초과
		 *  성적이 0 미만이거나 성적이 100초과이다
